...
namespace PayMent.Orders.Domain.Migrations
{
    ...
    [Migration("20250423174735_RefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayMent.Orders.Domain.Items.MerchantEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("merchantEntities");
                });

            modelBuilder.Entity("PayMent.Orders.Domain.Items.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PayMent.Orders.Domain.Models.Order", b =>
                {
                    ...
                    b.HasOne("PayMent.Orders.Domain.Items.MerchantEntity", "MerchantEntity")
                        .WithMany()
